  ...
  return (
    <>
      <nav style={{
        ...
        background: scrolled
          ? 'rgba(6,9,15,0.97)'
          : 'linear-gradient(180deg, rgba(6,9,15,0.9) 0%, rgba(6,9,15,0) 100%)',
        backdropFilter: scrolled ? 'blur(20px) saturate(180%)' : 'none',
        borderBottom: scrolled ? '1px solid rgba(232,160,32,0.1)' : '1px solid transparent',
        ...
        <div style={{
          ...
          <div style={{ display: 'flex', alignItems: 'center', gap: 2 }} className="center-nav">
            {navLinks.map(item => (
              ...
              onMouseEnter={e => { if (!isActive(item.href)) e.currentTarget.style.color = 'rgba(238,232,216,0.9)'; }}
          ...
          <div style={{ display: 'flex', alignItems: 'center', gap: 8 }} className="right-nav">
            ...
            {onCartClick && (
              <button onClick={onCartClick} style={{
                ...
                border: `1px solid ${cartCount > 0 ? 'rgba(232,160,32,0.4)' : 'rgba(255,255,255,0.08)'}`,
              ...
              onMouseLeave={e => {
                if (cartCount === 0) { e.currentTarget.style.background = 'rgba(255,255,255,0.04)'; e.currentTarget.style.borderColor = 'rgba(255,255,255,0.08)'; e.currentTarget.style.color = 'rgba(238,232,216,0.5)'; }
              }}>
                🛒
                {cartCount > 0 && (
                  <div style={{
                    ...
                    background: '#e8a020', color: '#06090f',
            ...
            {user ? (
              <div style={{ display: 'flex', alignItems: 'center', gap: 6 }}>
                ...
                onMouseEnter={e => { e.currentTarget.style.background = 'rgba(240,80,96,0.15)'; e.currentTarget.style.color = '#f05060'; }}
              ...
              onMouseEnter={e => { e.currentTarget.style.background = 'rgba(232,160,32,0.15)'; e.currentTarget.style.borderColor = 'rgba(232,160,32,0.45)'; e.currentTarget.style.color = '#e8a020'; }}
      ...
      {menuOpen && (
        <div style={{
          ...
          background: 'rgba(6,9,15,0.98)', backdropFilter: 'blur(20px)',
